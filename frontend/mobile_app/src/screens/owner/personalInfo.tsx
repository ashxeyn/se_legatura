...
// Simplified date input without external picker dependency
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            <TextInput
              ...
              placeholder="Date of Birth * (YYYY-MM-DD, e.g., 1990-01-15)"
              placeholderTextColor="#999"
              keyboardType="numeric"
              maxLength={10}
            />
            <Text style={styles.fieldHint}>Format: YYYY-MM-DD (must be 18+ years old)</Text>
          </View>
