...
(35, 3, 2, 10, 7, 17, 'Delay', 'asdasd', 'open', NULL, '2025-11-14 08:35:33', '2025-11-18 06:45:47'),
(36, 5, 2, 10, 8, 18, 'Payment', 'asdsd', 'open', NULL, '2025-11-15 04:45:57', '2025-11-18 13:52:09'),
(44, 3, 2, 10, 7, 16, 'Delay', 'asdasd', 'open', NULL, '2025-11-18 16:20:06', NULL);
...
CREATE TABLE `progress` (
  ...
  `progress_status` enum('submitted','under_review','approved','rejected','deleted') DEFAULT 'submitted',
  `submitted_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(25, NULL, 'qweqweeqweqwe', 'asjjhxeyn@gmail.com', '$2y$12$7hIhwmsJEQI9aw72O3mHCOlq5WRaZU.ACT4l73xXtA5Ph5WCYHUha', '$2y$12$6QbbV6rkmUtnprY4q91ukeLA9CPeCUDECsNQsYVtvWxCIwoPJCsv6', 'property_owner', 0, 0, '2025-11-15 05:36:42', '2025-11-16 11:23:22'),
...
--
ALTER TABLE `disputes`
  MODIFY `dispute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
